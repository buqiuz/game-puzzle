...
export class NavigationData {
    toolBarList: ToolbarItem[] = [
        { 'value': "首页", 'icon': { "id": 16777246, "type": 20000, params: [], "bundleName": "ohos.samples.gamepuzzle", "moduleName": "entry" }, 'action': () => { } },
        { 'value': "收藏", 'icon': { "id": 16777251, "type": 20000, params: [], "bundleName": "ohos.samples.gamepuzzle", "moduleName": "entry" }, 'action': () => { } },
        { 'value': "个人中心", 'icon': { "id": 16777253, "type": 20000, params: [], "bundleName": "ohos.samples.gamepuzzle", "moduleName": "entry" }, 'action': () => { } }
    ];
