...
class Game1 extends ViewPU {
    ...
    ImageShow(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/Game1.ets(69:5)", "entry");
            Image.id('imageShow');
            Image.width('90%');
            Image.height(260);
    ...
    showOption(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/Game1.ets(85:5)", "entry");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/Game1.ets(87:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/Game1.ets(93:7)", "entry");
            Button.backgroundColor('#f5f5f5');
            Button.fontColor('#182431');
            Button.onClick(() => {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("entry/src/main/ets/pages/Game1.ets(106:7)", "entry");
                }, Column);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("entry/src/main/ets/pages/Game1.ets(108:9)", "entry");
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    If.create();
            ...
            NavDestination.debugLine("entry/src/main/ets/pages/Game1.ets(105:5)", "entry");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
