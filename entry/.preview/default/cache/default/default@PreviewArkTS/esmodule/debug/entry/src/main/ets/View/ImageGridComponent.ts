...
export class ImageGridComponent extends ViewPU {
    ...
    gameOver() {
        ...
        if (count === loop) {
            ...
            AlertDialog.show({ message: { "id": 16777235, "type": 10003, params: [], "bundleName": "ohos.samples.gamepuzzle", "moduleName": "entry" } });
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Grid.create();
            Grid.debugLine("entry/src/main/ets/View/ImageGridComponent.ets(47:5)", "entry");
            Grid.id('imageGrid');
            Grid.rowsTemplate(this.template[this.templateIndex]);
            Grid.columnsTemplate(this.template[this.templateIndex]);
            Grid.columnsGap({ "id": 16777220, "type": 10002, params: [], "bundleName": "ohos.samples.gamepuzzle", "moduleName": "entry" });
            Grid.rowsGap({ "id": 16777220, "type": 10002, params: [], "bundleName": "ohos.samples.gamepuzzle", "moduleName": "entry" });
            Grid.width(350);
            Grid.height(260);
            ...
            const forEachItemGenFunction = (_item, index) => {
                const item = _item;
                {
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        GridItem.backgroundColor(item.pixelMap === undefined ? { "id": 16777241, "type": 10001, params: [], "bundleName": "ohos.samples.gamepuzzle", "moduleName": "entry" } : { "id": 16777243, "type": 10001, params: [], "bundleName": "ohos.samples.gamepuzzle", "moduleName": "entry" });
                        GridItem.onClick(() => {
                        ...
                        GridItem.debugLine("entry/src/main/ets/View/ImageGridComponent.ets(49:9)", "entry");
                    };
                    const observedDeepRender = () => {
                        this.observeComponentCreation2(itemCreation2, GridItem);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Stack.create();
                            Stack.debugLine("entry/src/main/ets/View/ImageGridComponent.ets(50:11)", "entry");
                        }, Stack);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Image.create(item.pixelMap);
                            Image.debugLine("entry/src/main/ets/View/ImageGridComponent.ets(51:13)", "entry");
                            ...
                            if (this.showDigit) {
                                this.ifElseBranchUpdateFunction(0, () => {
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Text.debugLine("entry/src/main/ets/View/ImageGridComponent.ets(56:15)", "entry");
