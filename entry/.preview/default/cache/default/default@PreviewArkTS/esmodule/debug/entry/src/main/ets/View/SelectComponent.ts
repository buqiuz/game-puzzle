...
export class SelectComponent extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/View/SelectComponent.ets(15:5)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Select.create([{ value: '2 x 2', icon: { "id": 16777246, "type": 20000, params: [], "bundleName": "ohos.samples.gamepuzzle", "moduleName": "entry" } },
                { value: '3 x 3', icon: { "id": 16777246, "type": 20000, params: [], "bundleName": "ohos.samples.gamepuzzle", "moduleName": "entry" } },
                { value: '4 x 4', icon: { "id": 16777246, "type": 20000, params: [], "bundleName": "ohos.samples.gamepuzzle", "moduleName": "entry" } },
                { value: '5 x 5', icon: { "id": 16777246, "type": 20000, params: [], "bundleName": "ohos.samples.gamepuzzle", "moduleName": "entry" } },
                { value: '6 x 6', icon: { "id": 16777246, "type": 20000, params: [], "bundleName": "ohos.samples.gamepuzzle", "moduleName": "entry" } }]);
            Select.debugLine("entry/src/main/ets/View/SelectComponent.ets(16:7)", "entry");
